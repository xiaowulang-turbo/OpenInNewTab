...
var I18nLocales = {
    "en": {
        ...
        "privacyLocalStorageDesc1": "The extension uses Chrome's local storage (chrome.storage.sync) to save:",
        "privacyLocalStorageDesc2": "This data is stored locally on your device and synchronized across your Chrome browsers if you're signed in. We do not have access to this data.",
        ...
        "privacyPermScripting": "Used to inject content scripts on whitelisted domains",
    ...
    "zh-CN": {
        ...
        "privacyLocalStorageDesc1": "扩展使用 Chrome 的本地存储 (chrome.storage.sync) 来保存：",
        "privacyLocalStorageDesc2": "这些数据存储在您的设备本地，如果您已登录 Chrome，数据会在您的浏览器之间同步。我们无法访问这些数据。",
    ...
    "zh-TW": {
        ...
        "privacyLocalStorageDesc1": "擴充功能使用 Chrome 的本機儲存 (chrome.storage.sync) 來儲存：",
        "privacyLocalStorageDesc2": "這些資料儲存在您的裝置本機，如果您已登入 Chrome，資料會在您的瀏覽器之間同步。我們無法存取這些資料。",
        "privacyLocalStorageItem1": "使用者的白名單網域",
        "privacyLocalStorageTitle": "本機儲存",
        "privacyPermActiveTab": "用於偵測目前分頁的網域，實現快速加入功能",
        "privacyPermHost": "用於修改白名單網站上的連結",
        "privacyPermScripting": "用於向白名單網域的頁面注入內容腳本",
        "privacyPermStorage": "用於在本機儲存您的白名單設定",
